...
const DEFAULT_TEXTS = ["Catalogue", "Collections", "Wallpapers", "Archives"];
...
const DEFAULT_REVEAL_COLOR = "#0A5BD0";
...
export function BlobRevealCTA({
  ...
  return (
    <Link
      href={href}
      className={`group relative inline-flex items-center justify-center rounded-full border border-accent bg-accent px-6 py-3 shadow-lg transition-all duration-300 hover:scale-105 hover:bg-accent/90 hover:shadow-xl ${className}`}
    >
      <TextRevealBlur
        prefix="Explore "
        texts={["Catalogue →", "Collections →", "Wallpapers →", "Archives →"]}
        font={{
          fontSize: "16px",
          fontWeight: 700,
